				...
				<section class="slider">
					...
					<a href="https://elearning.uwezocollege.ac.ke/cmis/portal/" class="button">Apply Now!!!</a>
						<ul class="slides">
							<li>
								<div class="banner-info1">
									<h1>Our Mission <br> <span> Unlocking the potential in you</span></h1>
									<p>Intake in progress for professional and job specific skills training courses. Apply now!!!</p>
									
								</div>
							</li>
							<li>
								<div class="banner-info1">
									<h1>Our Motto <br> <span> Beyond Training</span></h1>
									<p>Intake in progress for professional and job specific skills training courses. Apply now!!!</p>
			...
			<div class="col-md-6 best-left wow fadeInRight animated" data-wow-delay=".5s">
				...
				<div class="bes-top">
					...
					<ul>
						...
						<li><div class="history-grid-image">
						<img src="images/caleb.jpeg" class="img-responsive zoom-img" alt="">
					</div>
						<h6><a href="/caleb">Caleb Kimuyu</a></h6>
						</li>
					</ul>
				</div>
			</div>
